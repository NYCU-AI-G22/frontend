...
export function PostButtonIcon() {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 16 16"
      id="Write-2--Streamline-Block---Free"
      height="16"
      width="16"
    >
      <desc>Write 2 Streamline Icon: https://streamlinehq.com</desc>
      <path
        fill="#000000"
        d="M0.000183105 16V9.00003L6.48967 2.51038l7.00003 7.00005L7 16H0.000183105Z"
      />
      <path
        fill="#000000"
        d="M14.5504 8.44978c0.9283 -0.92826 1.4498 -2.18726 1.4498 -3.50004C16.0002 2.21608 13.784 0 11.0504 0 9.73756 0 8.47849 0.521517 7.55021 1.44982l7.00019 6.99996Z"
      />
    </svg>
  );
}
export function DefaultAvator() {
  return (
    <svg
      width="24px"
      height="24px"
